...
# 第3堂: 製作衣服
這一堂之後,你將學會進一步編輯 Vroid Studio 裏的衣服!
選擇其中一個你想學的方案:
- 製作校服 (女裝)
- 製作校服 (男裝)

完成製作後,我們需要導出(export)角色檔案成 .VRM檔案

在開始之前,請打開Vroid Studio, 找回上一次的存檔
...
1. 
- 點擊 **Outfit**(上方第四格) --> **Top**(左邊第二格). 
- 點擊 **Custom**, 再點擊 **+** 按鈕.
- 選取 **Uniform Vest (Short Sleeve)**.
![](\Lesson3\lesson3-2.png)
2. 點擊 **Edit Texutre**.
![](\Lesson3\lesson3-3.png)
3. 運用Brush Tool(第二格) 為衣服上色.
- 你可以按 **Ctrl + Z** 還原上一步.
- 你可以長按 **Shift** 再用滑鼠左鍵拖動畫板. 
- 你可以在右上角選顔色,也可以輸入色碼(e.g. 白色是eeeeee)改顔色
建議色碼: 藍色: **8EB8D2**, 深藍: **131219**
- 你可以打開右上角的鏡像工具上色.
![](\Lesson3\lesson3-4.gif)
4. 導出圖片.
- 右鍵點擊**Default image** --> Export(導出).
![](\Lesson3\lesson3-5.gif)
5. 使用圖片修改網站修改圖片.
進入 https://pixlr.com/tw/x/#editor, 點擊 **打開圖像**. 選擇剛才的圖片.
![](\Lesson3\lesson3-5.5.gif)
6. 點擊右上角的 **添加圖層** --> **圖片**. 添加校徽和格子素材.
![](\Lesson3\lesson3-6.gif)
7. 將素材擺放到適當的位置.
![](\Lesson3\lesson3-7.gif)
8. 點擊 **儲存**, 選擇 **png** 檔案格式.
![](\Lesson3\lesson3-8.gif)
9. 導入圖片到 Vroid Studio.
- 你可以按 **Layers**旁邊的圖片按鈕導入圖片.
- 刪除原本的**Layers**圖層.
![](\Lesson3\lesson3-9.gif)
10. 在Vroid Studio 上調整圖片如適用.
![](\Lesson3\lesson3-10.gif)
11. 儲存檔案.
![](\Lesson3\lesson3-11.png)
12. 點擊 Bottoms --> Custom, 點擊 **+** 按鈕 --> 選取 **Pleated Skirt**.
...
### 1.2 男裝
1. 點擊 **Outfit**(上方第四格) --> **Top**(左邊第二格).在現有的樣板中找到shirt, 然後按**Edit Texture**.
![](\Lesson3\lesson3-14.png)
2. 右鍵點擊**Default image** --> Export(導出).
![](\Lesson3\lesson3-15.gif)
3. 使用圖片修改網站修改圖片.
進入 https://pixlr.com/tw/x/#editor, 點擊 **打開圖像**. 選擇剛才的圖片.
4. 利用左手邊的工具調節圖片的顔色.
在 **"顔色"**面板中，調節 **飽和度** 和 **溫度**,令白色變成藍色.
![](\Lesson3\lesson3-16.gif)
5. 點擊右上角的 **添加圖層** --> **圖片**. 添加校徽和格子素材.
![](\Lesson3\lesson3-17.gif)
6. 導入圖片到 Vroid Studio.
- 你可以按 **Layers**旁邊的圖片按鈕導入圖片.
- 刪除原本的**Layers**圖層.
![](\Lesson3\lesson3-18.gif)
7. 在Vroid Studio 上調整圖片如適用
- 你可以按 **Ctrl + Z** 還原上一步.
- 你可以長按 **Shift** 再用滑鼠左鍵拖動畫板. 
- 你可以在右上角選顔色,也可以輸入色碼(e.g. 白色是eeeeee)改顔色
...
10. 到**Bottoms**選取現成的褲子.
![](\Lesson3\lesson3-21.png)

## 2. 導出 .VRM 檔案
1. 在右上角點擊**導出圖案**, 再選取**Export as VRM**.
![](\Lesson3\lesson3-22.png)
2. 根據以下的圖片調整參數以減低檔案的大小:
- 選取 **Hair Cross-Section**
- Hair **smoothness, Hair, Face, Body** --> 50
- **materials** 選取 2, **resolution** 選取 2048*2048.
![](\Lesson3\lesson3-23.png)
3. 點擊 **Export**, 輸入 Title 名稱 和 Creater 名稱, 格式為 班別+學號+英文全名 (e.g. 1D55 Chan Tai Man).
